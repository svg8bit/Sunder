...
| Browser wallet and balance | Wallet Standard + encrypted embedded signer implemented | Multi-connector Wallet Standard registry plus browser-local AES-GCM vault; selected signer balances poll confirmed RPC every 10 s | EIP-1193/wagmi implemented | EIP-1193/wagmi implemented |
