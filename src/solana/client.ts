...
export function solanaClientFor(network: ChainNetworkId) {
  ...
  mainnetClient ??= client(
    import.meta.env.VITE_SOLANA_MAINNET_RPC_URL?.trim() || "https://api.mainnet-beta.solana.com",
    import.meta.env.VITE_SOLANA_MAINNET_WS_URL?.trim() || "wss://api.mainnet-beta.solana.com",
  );
